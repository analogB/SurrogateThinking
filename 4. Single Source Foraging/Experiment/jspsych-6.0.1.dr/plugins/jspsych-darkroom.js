...
jsPsych.plugins['darkroom'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<table><tr>' +
      '<td></td>'+
      '<td><div style="font-size:20pt"> <b>click left pane: -$'+trial.primaryDec/1000+',000 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; click right pane: -$'+ trial.surrogateDec/1000+',000</b></div></td>'+
      '<td></td>'+
      '</tr><tr>'+
...
if (trial.sellMap == true){
    ...
    function map(x, y, m) {
      ...
      if m > 0{
        var rand_file_index = jsPsych.randomization.shuffle(ordered_file_index)
      }
      if (x < y[0]) {
        return ['img/map/m' + m + '/map'+rand_file_index[0]+'.png', 'img/sprite/map1T.png']
      } else if (x < y[1]) {
        return ['img/map/m' + m + '/map'+rand_file_index[1]+'.png', 'img/sprite/map2T.png']
      } else {
        return ['img/map/m' + m + '/map'+rand_file_index[2]+'.png', 'img/sprite/map3T.png']
      }
    };
